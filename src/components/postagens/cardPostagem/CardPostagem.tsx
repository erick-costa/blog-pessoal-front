...
function CardPostagem({ post }: CardPostagemProps) {
  return (
    <div className="shadow-md border flex flex-col rounded overflow-hidden justify-between">
      <div>
        <div className="flex w-full bg-indigo-500 py-2 px-4 items-center gap-4">
          <img
